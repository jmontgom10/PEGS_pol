PRO S3_SELECT_INPUT_IMAGES, event
...
PRO S3_SELECT_PROCESSING_METHOD, event

  WIDGET_CONTROL, event.ID, SET_UVALUE=event.tab

END

PRO S3_SET_REBIN_PIXELS, event
...
PRO S3_SET_SMALLEST_MESH_BIN, event
...
PRO S3_SET_NUMBER_REBIN_LEVELS, event
...
PRO S3_SET_MINIMUM_MESH_SNR, event
