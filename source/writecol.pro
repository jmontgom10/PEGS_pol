...
;   HEADER - string array to appear before columns
;
; OPTIONAL OUTPUTS:
;
; COMMENTS:
...
;   16-Spet-2016 Added header capabilities
;-
;------------------------------------------------------------------------------
pro writecol, file, v1, v2, v3, v4, v5, v6, v7, v8, v9, $
              v10, v11, v12, v13, v14, v15, v16, v17, v18, v19, $
              FMT=fmt, FILNUM=filnum, HEADER=header, COMMENT=comment
...
;
  ...
  if keyword_set(HEADER) then begin
    FOR i=0,n_elements(header)-1 do begin
      printf, filnum, comment+header[i]
    ENDFOR
  endif
